...
#define EEPROM_I2C_GPIO_PORT				GPIOE			/* GPIO端口 */
#define EEPROM_I2C_GPIO_CLK			 	RCC_AHB1Periph_GPIOE		/* GPIO端口时钟 */
#define EEPROM_I2C_SCL_PIN					GPIO_Pin_1			/* 连接到SCL时钟线的GPIO */
#define EEPROM_I2C_SDA_PIN					GPIO_Pin_0			/* 连接到SDA数据线的GPIO */
